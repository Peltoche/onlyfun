...
func Test_WebSessions_Service(t *testing.T) {
	...
	t.Run("Create success", func(t *testing.T) {
		...
		services := newService(storageMock, tools)
	...
	t.Run("GetAllForUser success", func(t *testing.T) {
		...
		// Run
		res, err := services.GetAllForUser(ctx, user.ID(), &sqlstorage.PaginateCmd{Limit: 10})
	...
	t.Run("GetByToken success", func(t *testing.T) {
		...
		// Run
		res, err := services.GetByToken(ctx, secret.NewText(rawToken))
	...
	t.Run("GetFromReq success", func(t *testing.T) {
		...
		// Run
		res, err := services.GetFromReq(req)
	...
	t.Run("Delete success", func(t *testing.T) {
		...
		// Run
		err := services.Delete(ctx, &DeleteCmd{
			UserID: user.ID(),
			Token:  session.Token(),
		})
	...
	t.Run("DeleteAll success", func(t *testing.T) {
		...
		// Run
		err := services.DeleteAll(ctx, user.ID())
